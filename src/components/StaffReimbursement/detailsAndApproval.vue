<template>
    <div style="height: 100%;">
        <GoBack v-if="$store.state.UA !== 1">员工报销单详情</GoBack>
                        ...
                        <div class="wrap">
                            <div class="new-data">
                                <div class="head">
                                    ...
                                    <!--<span>编辑</span>-->
                                    <!--</div>-->
                                    <router-link :to="{name:'add',params:{name:'PersonExpense',detailData}}"
                            ...
                            <div class="reimburse-info info-wrap">
                                ...
                                <div class="summary">
                                    <div class="block">
                                        ...
                                        <span class="num" v-if="detailData.entrys">{{getTotal(detailData.entrys,'amount').toFixed(2)}}</span>
                                    </div>
                                    <div class="line"></div>
                                    <div class="block">
                                        <span class="label">发票总数</span>
                                        <span class="num">{{detailData.billCount}}</span>
                                    </div>
                                </div>
                                <div class="reimburse-list" v-if="detailData.entrys">
                                    <div class="reimburse-item" v-for="item in detailData.entrys">
                                        <div class="head">
                                            <div class="left">
                                                <i class="line"></i>
                                                <span>报销信息</span>
                                            ...
                                            <div class="right">
                                                <div @click="item.folded = !item.folded">
                                                    <p v-if="item.folded">
                                                        <span>展开</span>
                                                        <i class="icon"></i>
                                                    </p>
                                        ...
                                        <div class="content" :class="{itemFolded:!item.folded}">
                                            <div class="row">
                                                <div class="label">预算项目</div>
                                                <div class="right" v-if="item.budgetItem">
                                                    {{item.budgetItem.name}}{{item.budgetItem.number}}
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="label">预算用途</div>
                                                <div class="right">{{item.purpose.name}}</div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="right" v-if="item.accountView">
                                                    {{item.accountView.name}}{{item.accountView.number}}
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="label">费用承担</div>
                                                <div class="right">{{item.costCenter.name}}</div>
                                            </div>
                                            <div class="row">
                                                <div class="label">发票云</div>
                                                <div class="right">{{item.isInvoice}}</div>
                                            </div>
                                            <!--<div class="row">-->
                                            <!--<div class="label">税额</div>-->
                                            <!--<div class="right">{{item.taxAmount}}</div>-->
                                            <!--</div>-->
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="invoice-info info-wrap">
                                ...
                                <div class="list" v-if="detailData.invoices">
                                    <div class="item" v-for="item in detailData.invoices">
                                        <div class="head">
                                            <div class="left">
                                                <span>发票号码</span>
                                                <span>{{item.invNumber}}</span>
                                            </div>
                                            <div class="right">普</div>
                                        </div>
                                        <div class="body">
                                            <div class="row">
                                                <div class="left">
  ...
  export default {
    ...
    methods: {
      ...
      loadData(billId) {
        ...
        this.loading = true
        // axios.get(this.$url, {
        axios.get('http://rest.apizza.net/mock/c16745d80509aa726ad0a1ca0797d75f/getBillInfoPersonExpenseNew', {
          params: {
            path: 'getBillInfo',
            billId,
          }
          ...
          .then((response) => {
            ...
            if (this.detailData.entrys.length > 0) {
              this.detailData.entrys.forEach((item) => {
